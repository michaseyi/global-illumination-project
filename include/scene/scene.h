// scene stores primitives and lights, builds a bvh on demand,
// and answers ray queries.
...
public:
    ...
    // build the bvh from currently registered primitives. call once after the
    // scene is fully populated and before any rendering.
    void build();
